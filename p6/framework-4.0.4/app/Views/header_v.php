            ...
            <div class="container">        
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link text-light" href="<?php echo site_url('Beranda')?>">Home <span class="sr-only">(current)</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="<?php echo site_url('Program_Studi')?>">Prodi</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="<?php echo site_url('Mahasiswa')?>">Mahasiswa</a>
                    </li>
